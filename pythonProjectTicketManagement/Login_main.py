...
initialize_app(cred, {"databaseURL": "https://my-python-project-47230-default-rtdb.asia-southeast1.firebasedatabase"
                                     ".app/"})
...
def open_homepage():
    ...
    # Button for search
    search_button = tk.Button(homepage, text="Search", command=lambda: search_transport(transport_mode))
